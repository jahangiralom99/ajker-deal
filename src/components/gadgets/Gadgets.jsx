    ...
    <div className=" my-10 md:bg-[#F5F5F5] pb-2 border-t-2 md:border-none border-blue-300">
      <div className=" mx-auto">
        ...
        <Tabs selectedIndex={tabIndex} onSelect={(index) => setTabIndex(index)} className=" ">
          <TabList role="tablist" className=" text-center  flex justify-center  gap-2 py-2 flex-wrap ">
                    ...
                    .map((itm, index) => (
                      <Link key={index} to={`/item/${itm?.item_code}`}>
                        <div className="md:border-2  md:h-52 bg-white">
                          <img className="md:w-48 md:h-40 w-20 h-22" src={`https://erp.gawsiashop.com.bd${itm?.thumbnail}`} alt="" />
